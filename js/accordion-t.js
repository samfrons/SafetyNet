...
function postToFeed() {
    ...
    var e = {
        method: "feed",
        link: "http://4gds.localtunnel.com/",
        picture: "http://lifewithoutlimits.t-mobile.com/assets/map_header-61ebb7b801d97e1764d810630bc675ce.png",
        name: "T-Mobile Life Without Limits",
    ...
    v.fn.extend({
        ...
        set: function(e, t, n) {
            var r;
            return t === !1 ? v.
            removeAttr(e, n) : (r = v.propFix[n] || n, r in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())), n
        }
    }, V || (I = {
        name: !0,
        id: !0,
    ...
    e.rails = r = {
        ...
        disableElement: function(e) {
            e.data("ujs:enable-with", e.html()), e.html(e.
            data("disable-with")), e.bind("click.railsDisable", function(e) {
...
(window.jQuery), $(document).ready(function() {
    $("#image_grid .photo_stream_image").click(function() {
        var e = $(this).data("full-size-url");
        return setImage(e, $(this).data("index")), !1
    }), $("#next_image").click(function() {
        var e = $("#full_size_image").data("index"),
            t = $("#image_grid .photo_stream_image").length - 1;
        if (e < t) {
            var n = $("#photo_stream_image_" + e).next(".photo_stream_image").data("full-size-url");
            setImage(n, e + 1)
        } else {
            e = 0;
            var n = $("#photo_stream_image_" + e).data("full-size-url");
            setImage(n, e)
        }
        return !1
        ...
        var e = $("#full_size_image").data("index");
        if (e > 0) {
            var t = $("#photo_stream_image_" + e).prev(".photo_stream_image").data("full-size-url");
            setImage(t, e - 1)
        } else {
            e = $("#image_grid .photo_stream_image").length - 1;
            var t = $("#photo_stream_image_" + e).data("full-size-url");
            setImage(t, e)
        }
        return !1
    }), $("#bottom_videos .video_link").click(function() {
        //_gaq.push(["_trackEvent", "video-series", "click", $(this).data("video-id")]);
        var e = $(this).data("video-embed-id");
        $("#video_title").text($(this).data("video-title")), $("#video_caption").text($(this).data("video-caption")), ytPlayer.loadVideoById(e);
        var t = this;
        return $("html, body").animate({
            scrollTop: $(t).offset().top
        }, 0), !1
    }), $(".button_header_link").click(function() {
        if (!$(this).children("h1").hasClass("active")) {
            var e = $(this).attr("href");
            $(".content").removeClass("active-content"), $(e).addClass("active-content");
            var t = $(this).children("h1");
            $(".button_header").removeClass("active"), t.addClass("active");
            var n = this;
            setTimeout(function() {
                $("html, body").animate({
                    scrollTop: $(n).offset().top
                }, 0)
            }, 250), this.id == "page4_header_link" && ($("#photo_view").hide(), $("#page4").show())
        } else {
            var e = $(this).attr("href");
            $(e).removeClass("active-content");
            var t = $(this).children("h1");
...
is_chrome && $("head").append('<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=0.8, maximum-scale=0.8, user-scalable=no,target-densityDpi=160dpi" />');
...
if (ua.indexOf("Android") >= 0) {
    ...
    androidversion < 3 && $("head").append('<meta name="viewport" content="width=device-width, initial-scale=0.5, minimum-scale=0.5, maximum-scale=0.5, user-scalable=no,target-densityDpi=deviceDpi" />')
}; 